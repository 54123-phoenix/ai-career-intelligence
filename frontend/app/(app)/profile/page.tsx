      ...
      <div className="space-y-6">
          ...
          <div className="mt-4">
            ...
            <input
              ...
              onChange={(e) =>
                setProfile({
                  ...profile,
                  career_goals: e.target.value.split(',').map((s) => s.trim()),
                })
              }
            />
          </div>
        ...
        <section className="rounded-xl border bg-white p-6 shadow-sm dark:border-gray-700 dark:bg-slate-900">
          ...
          <div className="space-y-2 text-sm">
            {history.length === 0 && <p className="text-gray-400 dark:text-gray-500">暂无记录</p>}
            {history.map((item) => (
              <div
                key={item.id}
