...
RESUMES: dict[str, StructuredResume] = {
    # ── P5 初级工程师 (1-2年) ──
    "res-zhang-wei": StructuredResume(
        resume_id="res-zhang-wei",
        name="张伟",
    ...
    # ── P6 中级工程师 (3-4年) ──
    "res-wang-fang": StructuredResume(
        resume_id="res-wang-fang",
        name="王芳",
    ...
    "res-chen-gang": StructuredResume(
        resume_id="res-chen-gang",
        name="陈刚",
    ...
    # ── P7 高级工程师 (5-7年) ──
    "res-zhao-min": StructuredResume(
        resume_id="res-zhao-min",
        name="赵敏",
    ...
    "res-sun-yang": StructuredResume(
        resume_id="res-sun-yang",
        name="孙阳",
    ...
    "res-liu-yang": StructuredResume(
        resume_id="res-liu-yang",
        name="柳洋",
    ...
    "res-huang-jie": StructuredResume(
        resume_id="res-huang-jie",
        name="黄杰",
        email="huangjie@example.com",
        phone="13800001008",
    ...
    "res-zhou-xue": StructuredResume(
        resume_id="res-zhou-xue",
        name="周雪",
        email="zhouxue@example.com",
        phone="13800001009",
    ...
    "res-lin-tao": StructuredResume(
        resume_id="res-lin-tao",
        name="林涛",
